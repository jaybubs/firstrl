...
class HistoryViewer(EventHandler):
    ...
    def on_render(self, console: tcodConsole) -> None:
...
class CharacterScreenEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        console.print(
            x=x + 1,
            y=y + 3,
            string=f"Next level: {self.engine.player.level.experience_to_next_level}",
        )
        console.print(
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def ev_mousebuttondown(
        ...
        """don't allow the player to click, thus forcing them to lup"""
        return None
