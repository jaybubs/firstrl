...
class Action:
    ...
    def perform(self) -> None:
        ...
        self.entity is the object performing the oction
        this method must be overridedn by action subclasses
        """
...
class ActionWithDirection(Action):
    ...
    @property
    def blocking_entity(self) -> Optional[Ent]:
...
class BumpAction(ActionWithDirection):
    """decides whether to move or attack"""
